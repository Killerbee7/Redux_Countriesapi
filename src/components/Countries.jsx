                ...
                <Card className="h-100">
                  <Card.Body className="d-flex flex-column">
                    <Card.Img
                      ...
                      onError={(event) => {
                        event.target.src =
                          "https://images.unsplash.com/photo-1594322436404-5a0526db4d13?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1429&q=80";
                        event.onerror = null;
                      }}
                    />
